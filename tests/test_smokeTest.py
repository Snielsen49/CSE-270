...
class TestSmokeTest():
  ...
  def test_test1(self):
    ...
    self.driver.set_window_size(1253, 816)
  ...
  def test_test3(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1254, 816)
  ...
  def test_test4(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("builder")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("building")
  ...
  def test_test5(self):
    ...
    self.driver.find_element(By.ID, "password").send_keys("idk")
